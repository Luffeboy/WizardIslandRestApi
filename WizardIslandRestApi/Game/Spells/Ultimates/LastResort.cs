...
namespace WizardIslandRestApi.Game.Spells.Ultimates
{
    public class LastResort : Spell
    {
        ...
        public override int CurrentCooldown { get => MyPlayer.Stats.Health <= MyPlayer.Stats.MaxHealth/3 ? _cooldown : GetCurrentGameTick() + Game._updatesPerSecond; set => _cooldown = value; }
