...
namespace WizardIslandRestApi.Game.Spells.Movement
{
    public class Phoenix : Spell
    {
        ...
        public override int CurrentCooldown { get => (_currentCooldown > GetCurrentGameTick() ||  (MyPlayer.IsInLava && MyPlayer.Stats.Health < MyPlayer.Stats.MaxHealth / 3)) ? _currentCooldown : GetCurrentGameTick() + Game._updatesPerSecond*100/3; set => _currentCooldown = value; }
